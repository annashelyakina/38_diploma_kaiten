# Проект по автоматическому тестированию сценариев для веб-сайта компании [Kaiten](https://kaiten.ru/)
<img width="30%" title="Kaiten" src="media/logo/logo.png">
Kaiten — платформа для управления проектами и задачами, которая помогает командам работать быстрее и продуктивнее. 
